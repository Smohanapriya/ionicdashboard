...
import * as import9 from 'ng2-chartjs2/index';
...
import * as import46 from '../providers/connection-service';
import * as import47 from '../providers/sales-service';
import * as import48 from '../providers/allpurchase-service';
import * as import49 from '../providers/allsales-service';
import * as import50 from '../providers/allstocks-service';
import * as import51 from '../providers/purchase-service';
import * as import52 from '../providers/staff-service';
import * as import53 from '../providers/stocks-service';
...
import * as import65 from '../pages/purchase/purchase.ngfactory';
import * as import66 from '../pages/purchases/purchases.ngfactory';
import * as import67 from '../pages/sale/sale.ngfactory';
import * as import68 from '../pages/sales/sales.ngfactory';
import * as import69 from '../pages/setting/setting.ngfactory';
import * as import70 from '../pages/staff/staff.ngfactory';
import * as import71 from '../pages/stock/stock.ngfactory';
import * as import72 from '../pages/stocks/stocks.ngfactory';
import * as import73 from '../pages/sales-graph/sales-graph.ngfactory';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __DeepLinker_75:any;
  __ConnectionService_76:import46.ConnectionService;
  __SalesService_77:import47.SalesService;
  __AllPurchaseService_78:import48.AllPurchaseService;
  __AllSalesService_79:import49.AllSalesService;
  __AllStocksService_80:import50.AllStocksService;
  ...
  constructor(parent:import54.Injector) {
    super(parent,[
      ...
      import63.MyAppNgFactory,
      import63.MyAppNgFactory,
      import64.HomePageNgFactory,
      import65.PurchasePageNgFactory,
      import66.PurchasesPageNgFactory,
      import67.SalePageNgFactory,
      import68.SalesPageNgFactory,
      import69.SettingPageNgFactory,
      import70.StaffPageNgFactory,
      import71.StockPageNgFactory,
      import72.StocksPageNgFactory,
      import73.SalesGraphNgFactory,
      import57.IonicAppNgFactory
    ]
    ,[import57.IonicAppNgFactory]);
  }
  ...
  get _APP_ID_30():any {
    if ((this.__APP_ID_30 == (null as any))) { (this.__APP_ID_30 = import74._appIdRandomProviderFactory()); }
  ...
  get _EVENT_MANAGER_PLUGINS_33():any[] {
    if ((this.__EVENT_MANAGER_PLUGINS_33 == (null as any))) { (this.__EVENT_MANAGER_PLUGINS_33 = [
      ...
      new import77.HammerGesturesPlugin(this._HAMMER_GESTURE_CONFIG_32)
    ]
    ); }
    return this.__EVENT_MANAGER_PLUGINS_33;
  }
  get _EventManager_34():import17.EventManager {
    if ((this.__EventManager_34 == (null as any))) { (this.__EventManager_34 = new import17.EventManager(this._EVENT_MANAGER_PLUGINS_33,this.parent.get(import78.NgZone))); }
  ...
  get _RootRenderer_38():any {
    if ((this.__RootRenderer_38 == (null as any))) { (this.__RootRenderer_38 = import79._createConditionalRootRenderer(this._DomRootRenderer_37,this.parent.get(import79.NgProbeToken,(null as any)))); }
  ...
  get _AppRootToken_54():any {
    if ((this.__AppRootToken_54 == (null as any))) { (this.__AppRootToken_54 = import80.MyApp); }
  ...
  get _Keyboard_62():import35.Keyboard {
    if ((this.__Keyboard_62 == (null as any))) { (this.__Keyboard_62 = new import35.Keyboard(this._Config_22,this._Form_59,this.parent.get(import78.NgZone))); }
  ...
  get _LocationStrategy_64():any {
    if ((this.__LocationStrategy_64 == (null as any))) { (this.__LocationStrategy_64 = import8.provideLocationStrategy(this.parent.get(import81.PlatformLocation),this.parent.get(import82.APP_BASE_HREF,(null as any)),this._Config_22)); }
  ...
  get _TapClick_70():import42.TapClick {
    if ((this.__TapClick_70 == (null as any))) { (this.__TapClick_70 = new import42.TapClick(this._Config_22,this._App_23,this.parent.get(import78.NgZone))); }
  ...
  get _UrlSerializer_74():any {
    if ((this.__UrlSerializer_74 == (null as any))) { (this.__UrlSerializer_74 = import83.setupUrlSerializer(this._DeepLinkConfigToken_55)); }
    return this.__UrlSerializer_74;
  }
  get _DeepLinker_75():any {
    if ((this.__DeepLinker_75 == (null as any))) { (this.__DeepLinker_75 = import84.setupDeepLinker(this._App_23,this._UrlSerializer_74,this._Location_65)); }
    return this.__DeepLinker_75;
  }
  get _ConnectionService_76():import46.ConnectionService {
    if ((this.__ConnectionService_76 == (null as any))) { (this.__ConnectionService_76 = new import46.ConnectionService(this._Platform_21)); }
    return this.__ConnectionService_76;
  }
  get _SalesService_77():import47.SalesService {
    if ((this.__SalesService_77 == (null as any))) { (this.__SalesService_77 = new import47.SalesService(this._Http_51,this._ConnectionService_76)); }
    return this.__SalesService_77;
  }
  get _AllPurchaseService_78():import48.AllPurchaseService {
    if ((this.__AllPurchaseService_78 == (null as any))) { (this.__AllPurchaseService_78 = new import48.AllPurchaseService(this._Http_51,this._ConnectionService_76)); }
    return this.__AllPurchaseService_78;
  }
  get _AllSalesService_79():import49.AllSalesService {
    if ((this.__AllSalesService_79 == (null as any))) { (this.__AllSalesService_79 = new import49.AllSalesService(this._Http_51,this._ConnectionService_76)); }
    return this.__AllSalesService_79;
  }
  get _AllStocksService_80():import50.AllStocksService {
    if ((this.__AllStocksService_80 == (null as any))) { (this.__AllStocksService_80 = new import50.AllStocksService(this._Http_51,this._ConnectionService_76)); }
    return this.__AllStocksService_80;
  }
  get _PurchaseService_81():import51.PurchaseService {
    if ((this.__PurchaseService_81 == (null as any))) { (this.__PurchaseService_81 = new import51.PurchaseService(this._Http_51,this._ConnectionService_76)); }
    return this.__PurchaseService_81;
  }
  get _StaffService_82():import52.StaffService {
    if ((this.__StaffService_82 == (null as any))) { (this.__StaffService_82 = new import52.StaffService(this._Http_51,this._ConnectionService_76)); }
    return this.__StaffService_82;
  }
  get _StocksService_83():import53.StocksService {
  ...
  createInternal():import1.AppModule {
    ...
    this._QueryParams_15 = import85.setupQueryParams(this._UrlToken_14);
    this._PlatformConfigToken_16 = import86.providePlatformConfigs();
    ...
    this._Platform_21 = import87.setupPlatform(this._PlatformConfigToken_16,this._QueryParams_15,this._UserAgentToken_17,this._NavigatorPlatformToken_18,this._DocumentDirToken_19,this._DocLangToken_20,this.parent.get(import78.NgZone));
    this._Config_22 = import88.setupConfig(this._ConfigToken_13,this._QueryParams_15,this._Platform_21);
    this._App_23 = new import11.App(this._Config_22,this._Platform_21);
    this._APP_INITIALIZER_24 = [
      import89.registerModeConfigs(this._Config_22),
      import90.registerTransitions(this._Config_22),
      import31.setupProvideEvents(this._Platform_21),
      import42.setupTapClick(this._Config_22,this._App_23,this.parent.get(import78.NgZone))
    ]
    ;
    this._ApplicationInitStatus_25 = new import12.ApplicationInitStatus(this._APP_INITIALIZER_24);
    this._Testability_26 = new import13.Testability(this.parent.get(import78.NgZone));
    this._ApplicationRef__27 = new import14.ApplicationRef_(this.parent.get(import78.NgZone),this.parent.get(import91.Console),this,this._ErrorHandler_12,this,this._ApplicationInitStatus_25,this.parent.get(import13.TestabilityRegistry,(null as any)),this._Testability_26);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import92.LOCALE_ID)) { return this._LOCALE_ID_10; }
    if ((token === import10.NgLocalization)) { return this._NgLocalization_11; }
    if ((token === import93.ErrorHandler)) { return this._ErrorHandler_12; }
    if ((token === import88.ConfigToken)) { return this._ConfigToken_13; }
    if ((token === import85.UrlToken)) { return this._UrlToken_14; }
    if ((token === import85.QueryParams)) { return this._QueryParams_15; }
    if ((token === import86.PlatformConfigToken)) { return this._PlatformConfigToken_16; }
    if ((token === import87.UserAgentToken)) { return this._UserAgentToken_17; }
    if ((token === import87.NavigatorPlatformToken)) { return this._NavigatorPlatformToken_18; }
    if ((token === import87.DocumentDirToken)) { return this._DocumentDirToken_19; }
    if ((token === import87.DocLangToken)) { return this._DocLangToken_20; }
    if ((token === import87.Platform)) { return this._Platform_21; }
    if ((token === import88.Config)) { return this._Config_22; }
    ...
    if ((token === import74.APP_ID)) { return this._APP_ID_30; }
    if ((token === import94.DOCUMENT)) { return this._DOCUMENT_31; }
    if ((token === import77.HAMMER_GESTURE_CONFIG)) { return this._HAMMER_GESTURE_CONFIG_32; }
    ...
    if ((token === import95.AnimationDriver)) { return this._AnimationDriver_36; }
    if ((token === import19.DomRootRenderer)) { return this._DomRootRenderer_37; }
    if ((token === import96.RootRenderer)) { return this._RootRenderer_38; }
    if ((token === import20.DomSanitizer)) { return this._DomSanitizer_39; }
    if ((token === import97.Sanitizer)) { return this._Sanitizer_40; }
    if ((token === import21.ViewUtils)) { return this._ViewUtils_41; }
    if ((token === import98.IterableDiffers)) { return this._IterableDiffers_42; }
    if ((token === import99.KeyValueDiffers)) { return this._KeyValueDiffers_43; }
    ...
    if ((token === import102.AppRootToken)) { return this._AppRootToken_54; }
    if ((token === import83.DeepLinkConfigToken)) { return this._DeepLinkConfigToken_55; }
    ...
    if ((token === import82.LocationStrategy)) { return this._LocationStrategy_64; }
    ...
    if ((token === import83.UrlSerializer)) { return this._UrlSerializer_74; }
    if ((token === import84.DeepLinker)) { return this._DeepLinker_75; }
    if ((token === import46.ConnectionService)) { return this._ConnectionService_76; }
    if ((token === import47.SalesService)) { return this._SalesService_77; }
    if ((token === import48.AllPurchaseService)) { return this._AllPurchaseService_78; }
    if ((token === import49.AllSalesService)) { return this._AllSalesService_79; }
    if ((token === import50.AllStocksService)) { return this._AllStocksService_80; }
