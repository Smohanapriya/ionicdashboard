...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __DeepLinker_74:any;
  __ConnectionService_75:import45.ConnectionService;
  __SalesService_76:import46.SalesService;
  __AllPurchaseService_77:import47.AllPurchaseService;
  __AllSalesService_78:import48.AllSalesService;
  __AllStocksService_79:import49.AllStocksService;
  __PurchaseService_80:import50.PurchaseService;
  __StaffService_81:import51.StaffService;
  __StocksService_82:import52.StocksService;
  ...
  get _APP_ID_29():any {
    if ((this.__APP_ID_29 == (null as any))) { (this.__APP_ID_29 = import72._appIdRandomProviderFactory()); }
  ...
  get _EventManager_33():import16.EventManager {
    if ((this.__EventManager_33 == (null as any))) { (this.__EventManager_33 = new import16.EventManager(this._EVENT_MANAGER_PLUGINS_32,this.parent.get(import76.NgZone))); }
  ...
  get _RootRenderer_37():any {
    if ((this.__RootRenderer_37 == (null as any))) { (this.__RootRenderer_37 = import77._createConditionalRootRenderer(this._DomRootRenderer_36,this.parent.get(import77.NgProbeToken,(null as any)))); }
  ...
  get _AppRootToken_53():any {
    if ((this.__AppRootToken_53 == (null as any))) { (this.__AppRootToken_53 = import78.MyApp); }
  ...
  get _Keyboard_61():import34.Keyboard {
    if ((this.__Keyboard_61 == (null as any))) { (this.__Keyboard_61 = new import34.Keyboard(this._Config_21,this._Form_58,this.parent.get(import76.NgZone))); }
  ...
  get _LocationStrategy_63():any {
    if ((this.__LocationStrategy_63 == (null as any))) { (this.__LocationStrategy_63 = import8.provideLocationStrategy(this.parent.get(import79.PlatformLocation),this.parent.get(import80.APP_BASE_HREF,(null as any)),this._Config_21)); }
  ...
  get _TapClick_69():import41.TapClick {
    if ((this.__TapClick_69 == (null as any))) { (this.__TapClick_69 = new import41.TapClick(this._Config_21,this._App_22,this.parent.get(import76.NgZone))); }
  ...
  get _UrlSerializer_73():any {
    if ((this.__UrlSerializer_73 == (null as any))) { (this.__UrlSerializer_73 = import81.setupUrlSerializer(this._DeepLinkConfigToken_54)); }
    return this.__UrlSerializer_73;
  }
  get _DeepLinker_74():any {
    if ((this.__DeepLinker_74 == (null as any))) { (this.__DeepLinker_74 = import82.setupDeepLinker(this._App_22,this._UrlSerializer_73,this._Location_64)); }
    return this.__DeepLinker_74;
  }
  get _ConnectionService_75():import45.ConnectionService {
    if ((this.__ConnectionService_75 == (null as any))) { (this.__ConnectionService_75 = new import45.ConnectionService(this._Platform_20)); }
    return this.__ConnectionService_75;
  }
  get _SalesService_76():import46.SalesService {
    if ((this.__SalesService_76 == (null as any))) { (this.__SalesService_76 = new import46.SalesService(this._Http_50,this._ConnectionService_75)); }
    return this.__SalesService_76;
  }
  get _AllPurchaseService_77():import47.AllPurchaseService {
    if ((this.__AllPurchaseService_77 == (null as any))) { (this.__AllPurchaseService_77 = new import47.AllPurchaseService(this._Http_50,this._ConnectionService_75)); }
    return this.__AllPurchaseService_77;
  }
  get _AllSalesService_78():import48.AllSalesService {
    if ((this.__AllSalesService_78 == (null as any))) { (this.__AllSalesService_78 = new import48.AllSalesService(this._Http_50,this._ConnectionService_75)); }
    return this.__AllSalesService_78;
  }
  get _AllStocksService_79():import49.AllStocksService {
    if ((this.__AllStocksService_79 == (null as any))) { (this.__AllStocksService_79 = new import49.AllStocksService(this._Http_50,this._ConnectionService_75)); }
    return this.__AllStocksService_79;
  }
  get _PurchaseService_80():import50.PurchaseService {
    if ((this.__PurchaseService_80 == (null as any))) { (this.__PurchaseService_80 = new import50.PurchaseService(this._Http_50,this._ConnectionService_75)); }
    return this.__PurchaseService_80;
  }
  get _StaffService_81():import51.StaffService {
    if ((this.__StaffService_81 == (null as any))) { (this.__StaffService_81 = new import51.StaffService(this._Http_50,this._ConnectionService_75)); }
    return this.__StaffService_81;
  }
  get _StocksService_82():import52.StocksService {
    if ((this.__StocksService_82 == (null as any))) { (this.__StocksService_82 = new import52.StocksService(this._Http_50,this._ConnectionService_75)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._ApplicationRef__26 = new import13.ApplicationRef_(this.parent.get(import76.NgZone),this.parent.get(import89.Console),this,this._ErrorHandler_11,this,this._ApplicationInitStatus_24,this.parent.get(import12.TestabilityRegistry,(null as any)),this._Testability_25);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import90.LOCALE_ID)) { return this._LOCALE_ID_9; }
    if ((token === import9.NgLocalization)) { return this._NgLocalization_10; }
    if ((token === import91.ErrorHandler)) { return this._ErrorHandler_11; }
    if ((token === import86.ConfigToken)) { return this._ConfigToken_12; }
    if ((token === import83.UrlToken)) { return this._UrlToken_13; }
    if ((token === import83.QueryParams)) { return this._QueryParams_14; }
    if ((token === import84.PlatformConfigToken)) { return this._PlatformConfigToken_15; }
    if ((token === import85.UserAgentToken)) { return this._UserAgentToken_16; }
    if ((token === import85.NavigatorPlatformToken)) { return this._NavigatorPlatformToken_17; }
    if ((token === import85.DocumentDirToken)) { return this._DocumentDirToken_18; }
    if ((token === import85.DocLangToken)) { return this._DocLangToken_19; }
    if ((token === import85.Platform)) { return this._Platform_20; }
    if ((token === import86.Config)) { return this._Config_21; }
    ...
    if ((token === import72.APP_ID)) { return this._APP_ID_29; }
    if ((token === import92.DOCUMENT)) { return this._DOCUMENT_30; }
    if ((token === import75.HAMMER_GESTURE_CONFIG)) { return this._HAMMER_GESTURE_CONFIG_31; }
    ...
    if ((token === import93.AnimationDriver)) { return this._AnimationDriver_35; }
    if ((token === import18.DomRootRenderer)) { return this._DomRootRenderer_36; }
    if ((token === import94.RootRenderer)) { return this._RootRenderer_37; }
    if ((token === import19.DomSanitizer)) { return this._DomSanitizer_38; }
    if ((token === import95.Sanitizer)) { return this._Sanitizer_39; }
    if ((token === import20.ViewUtils)) { return this._ViewUtils_40; }
    if ((token === import96.IterableDiffers)) { return this._IterableDiffers_41; }
    if ((token === import97.KeyValueDiffers)) { return this._KeyValueDiffers_42; }
    ...
    if ((token === import100.AppRootToken)) { return this._AppRootToken_53; }
    if ((token === import81.DeepLinkConfigToken)) { return this._DeepLinkConfigToken_54; }
    ...
    if ((token === import80.LocationStrategy)) { return this._LocationStrategy_63; }
    ...
    if ((token === import81.UrlSerializer)) { return this._UrlSerializer_73; }
    if ((token === import82.DeepLinker)) { return this._DeepLinker_74; }
    if ((token === import45.ConnectionService)) { return this._ConnectionService_75; }
    if ((token === import46.SalesService)) { return this._SalesService_76; }
    if ((token === import47.AllPurchaseService)) { return this._AllPurchaseService_77; }
    if ((token === import48.AllSalesService)) { return this._AllSalesService_78; }
    if ((token === import49.AllStocksService)) { return this._AllStocksService_79; }
    if ((token === import50.PurchaseService)) { return this._PurchaseService_80; }
    if ((token === import51.StaffService)) { return this._StaffService_81; }
    if ((token === import52.StocksService)) { return this._StocksService_82; }
