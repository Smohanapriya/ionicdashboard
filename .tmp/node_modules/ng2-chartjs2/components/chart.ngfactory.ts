...
class _View_ChartComponent_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._appEl_0.initComponent(this._ChartComponent_0_4,([] as any[]),compView_0);
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (!throwOnChange) { this._ChartComponent_0_4.ngDoCheck(); }
...
function viewFactory_ChartComponent_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_ChartComponent_Host === (null as any))) { (renderType_ChartComponent_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_ChartComponent_Host0(viewUtils,parentInjector,declarationEl);
}
export const ChartComponentNgFactory:import10.ComponentFactory<import3.ChartComponent> = new import10.ComponentFactory<import3.ChartComponent>('chart',viewFactory_ChartComponent_Host0,import3.ChartComponent);
...
export function viewFactory_ChartComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.ChartComponent> {
  if ((renderType_ChartComponent === (null as any))) { (renderType_ChartComponent = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.Emulated,styles_ChartComponent,{})); }
