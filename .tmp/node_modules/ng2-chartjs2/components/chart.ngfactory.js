...
import * as import3 from 'ng2-chartjs2/components/chart';
...
var _View_ChartComponent_Host0 = (function (_super) {
    ...
    _View_ChartComponent_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._ChartComponent_0_4.ngOnInit();
        }
        if (!throwOnChange) {
            this._ChartComponent_0_4.ngDoCheck();
        }
        this.detectContentChildrenChanges(throwOnChange);
        this.detectViewChildrenChanges(throwOnChange);
    };
    _View_ChartComponent_Host0.prototype.destroyInternal = function () {
        this._ChartComponent_0_4.ngOnDestroy();
    };
...
function viewFactory_ChartComponent_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ChartComponent_Host === null)) {
        (renderType_ChartComponent_Host = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, [], {}));
    }
    return new _View_ChartComponent_Host0(viewUtils, parentInjector, declarationEl);
}
export var ChartComponentNgFactory = new import10.ComponentFactory('chart', viewFactory_ChartComponent_Host0, import3.ChartComponent);
var styles_ChartComponent = ['[_nghost-%COMP%] {display: block;}'];
...
export function viewFactory_ChartComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ChartComponent === null)) {
        (renderType_ChartComponent = viewUtils.createRenderComponentType('/Users/sivasakthisoftwares/Desktop/Android/ionicdashboard/node_modules/ng2-chartjs2/components/chart.d.ts class ChartComponent - inline template', 0, import9.ViewEncapsulation.Emulated, styles_ChartComponent, {}));
    }
