...
var renderType_PurchasePage_Host:import0.RenderComponentType = (null as any);
class _View_PurchasePage_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _PurchaseService_0_4:import3.PurchaseService;
  _PurchasePage_0_5:import4.PurchasePage;
  constructor(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement) {
    super(_View_PurchasePage_Host0,renderType_PurchasePage_Host,import7.ViewType.HOST,viewUtils,parentInjector,declarationEl,import8.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.selectOrCreateHostElement('page-purchase',rootSelector,(null as any));
    this._appEl_0 = new import2.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_PurchasePage0(this.viewUtils,this.injector(0),this._appEl_0);
    ...
    this._appEl_0.initComponent(this._PurchasePage_0_5,([] as any[]),compView_0);
    compView_0.create(this._PurchasePage_0_5,this.projectableNodes,(null as any));
    this.init(([] as any[]).concat([this._el_0]),[this._el_0],([] as any[]),([] as any[]));
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.PurchaseService) && (0 === requestNodeIndex))) { return this._PurchaseService_0_4; }
    if (((token === import4.PurchasePage) && (0 === requestNodeIndex))) { return this._PurchasePage_0_5; }
    return notFoundResult;
  }
}
function viewFactory_PurchasePage_Host0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_PurchasePage_Host === (null as any))) { (renderType_PurchasePage_Host = viewUtils.createRenderComponentType('',0,import12.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_PurchasePage_Host0(viewUtils,parentInjector,declarationEl);
}
export const PurchasePageNgFactory:import13.ComponentFactory<import4.PurchasePage> = new import13.ComponentFactory<import4.PurchasePage>('page-purchase',viewFactory_PurchasePage_Host0,import4.PurchasePage);
const styles_PurchasePage:any[] = ([] as any[]);
var renderType_PurchasePage:import0.RenderComponentType = (null as any);
class _View_PurchasePage0 extends import1.AppView<import4.PurchasePage> {
  _text_0:any;
  _el_1:any;
  ...
  /*private*/ _expr_4:any;
  constructor(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement) {
    super(_View_PurchasePage0,renderType_PurchasePage,import7.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import8.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Navbar_3_4 = new import15.Navbar(this.parentInjector.get(import23.App),this.parentInjector.get(import21.ViewController,(null as any)),this.parentInjector.get(import11.NavController,(null as any)),this.parentInjector.get(import19.Config),new import20.ElementRef(this._el_3),this.renderer);
    ...
    this._text_6 = this.renderer.createText((null as any),'Company (Purchase)',(null as any));
...
export function viewFactory_PurchasePage0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<import4.PurchasePage> {
  if ((renderType_PurchasePage === (null as any))) { (renderType_PurchasePage = viewUtils.createRenderComponentType('',0,import12.ViewEncapsulation.None,styles_PurchasePage,{})); }
  return new _View_PurchasePage0(viewUtils,parentInjector,declarationEl);
}
class _View_PurchasePage1 extends import1.AppView<any> {
  _el_0:any;
  ...
  constructor(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement) {
    super(_View_PurchasePage1,renderType_PurchasePage,import7.ViewType.EMBEDDED,viewUtils,parentInjector,declarationEl,import8.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._text_17 = this.renderer.createText(this._el_16,'Quantity',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import32.Grid) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 57)))) { return this._Grid_10_3; }
    if (((token === import31.CardContent) && ((8 <= requestNodeIndex) && (requestNodeIndex <= 58)))) { return this._CardContent_8_3; }
    if (((token === import31.Card) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 59)))) { return this._Card_0_3; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this.detectContentChildrenChanges(throwOnChange);
    const currVal_1:any = import5.interpolate(1,'card-tab-bg-',this.context.$implicit.color,' font-bold');
    if (import5.checkBinding(throwOnChange,this._expr_1,currVal_1)) {
    ...
    const currVal_5:any = import5.interpolate(1,' ',this.context.$implicit.qty,'');
    ...
    const currVal_8:any = import5.interpolate(1,' ',this.context.$implicit.amount,'');
    ...
    const currVal_11:any = import5.interpolate(1,' ',this.context.$implicit.taxamount,'');
    ...
    const currVal_14:any = import5.interpolate(1,' ',this.context.$implicit.profit,'%');
...
function viewFactory_PurchasePage1(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
