...
import * as import3 from './purchase';
import * as import4 from '@angular/core/src/linker/view_utils';
import * as import6 from '@angular/core/src/linker/view_type';
import * as import7 from '@angular/core/src/change_detection/change_detection';
import * as import8 from '../../providers/purchase-service';
...
var _View_PurchasePage_Host0 = (function (_super) {
    ...
    function _View_PurchasePage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_PurchasePage_Host0, renderType_PurchasePage_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_PurchasePage_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._PurchasePage_0_4 = new import3.PurchasePage(this.parentInjector.get(import8.PurchaseService), this.parentInjector.get(import9.LoadingController), this.parentInjector.get(import10.NavController));
        this._appEl_0.initComponent(this._PurchasePage_0_4, [], compView_0);
        compView_0.create(this._PurchasePage_0_4, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_PurchasePage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.PurchasePage) && (0 === requestNodeIndex))) {
            return this._PurchasePage_0_4;
        }
...
function viewFactory_PurchasePage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_PurchasePage_Host === null)) {
        (renderType_PurchasePage_Host = viewUtils.createRenderComponentType('', 0, import11.ViewEncapsulation.None, [], {}));
    }
    return new _View_PurchasePage_Host0(viewUtils, parentInjector, declarationEl);
}
export var PurchasePageNgFactory = new import12.ComponentFactory('page-purchase', viewFactory_PurchasePage_Host0, import3.PurchasePage);
...
var _View_PurchasePage0 = (function (_super) {
    ...
    function _View_PurchasePage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_PurchasePage0, renderType_PurchasePage, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_PurchasePage0.prototype.createInternal = function (rootSelector) {
        ...
        this._TemplateRef_12_5 = new import28.TemplateRef_(this._appEl_12, viewFactory_PurchasePage1);
...
var _View_PurchasePage1 = (function (_super) {
    ...
    function _View_PurchasePage1(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_PurchasePage1, renderType_PurchasePage, import6.ViewType.EMBEDDED, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    ...
    _View_PurchasePage1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import31.Grid) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 57)))) {
            return this._Grid_10_3;
        }
        if (((token === import30.CardContent) && ((8 <= requestNodeIndex) && (requestNodeIndex <= 58)))) {
            return this._CardContent_8_3;
        }
        if (((token === import30.Card) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 59)))) {
    ...
    _View_PurchasePage1.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_5 = import4.interpolate(1, ' ', this.context.$implicit.qty, '');
        ...
        var currVal_8 = import4.interpolate(1, ' ', this.context.$implicit.amount, '');
        ...
        var currVal_11 = import4.interpolate(1, ' ', this.context.$implicit.taxamount, '');
