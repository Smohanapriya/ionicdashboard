...
import * as import3 from '../../providers/purchase-service';
...
var renderType_PurchasePage_Host = null;
var _View_PurchasePage_Host0 = (function (_super) {
    __extends(_View_PurchasePage_Host0, _super);
    function _View_PurchasePage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_PurchasePage_Host0, renderType_PurchasePage_Host, import7.ViewType.HOST, viewUtils, parentInjector, declarationEl, import8.ChangeDetectorStatus.CheckAlways);
    }
    _View_PurchasePage_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('page-purchase', rootSelector, null);
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_PurchasePage0(this.viewUtils, this.injector(0), this._appEl_0);
        this._PurchaseService_0_4 = new import3.PurchaseService(this.parentInjector.get(import9.Http));
        this._PurchasePage_0_5 = new import4.PurchasePage(this._PurchaseService_0_4, this.parentInjector.get(import10.LoadingController), this.parentInjector.get(import11.NavController));
        this._appEl_0.initComponent(this._PurchasePage_0_5, [], compView_0);
        compView_0.create(this._PurchasePage_0_5, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_PurchasePage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.PurchaseService) && (0 === requestNodeIndex))) {
            return this._PurchaseService_0_4;
        }
        if (((token === import4.PurchasePage) && (0 === requestNodeIndex))) {
            return this._PurchasePage_0_5;
        }
        return notFoundResult;
    };
    return _View_PurchasePage_Host0;
}(import1.AppView));
function viewFactory_PurchasePage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_PurchasePage_Host === null)) {
        (renderType_PurchasePage_Host = viewUtils.createRenderComponentType('', 0, import12.ViewEncapsulation.None, [], {}));
    }
    return new _View_PurchasePage_Host0(viewUtils, parentInjector, declarationEl);
}
export var PurchasePageNgFactory = new import13.ComponentFactory('page-purchase', viewFactory_PurchasePage_Host0, import4.PurchasePage);
var styles_PurchasePage = [];
var renderType_PurchasePage = null;
var _View_PurchasePage0 = (function (_super) {
    __extends(_View_PurchasePage0, _super);
    function _View_PurchasePage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_PurchasePage0, renderType_PurchasePage, import7.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import8.ChangeDetectorStatus.CheckAlways);
    }
    _View_PurchasePage0.prototype.createInternal = function (rootSelector) {
        ...
        this._Navbar_3_4 = new import15.Navbar(this.parentInjector.get(import23.App), this.parentInjector.get(import21.ViewController, null), this.parentInjector.get(import11.NavController, null), this.parentInjector.get(import19.Config), new import20.ElementRef(this._el_3), this.renderer);
        ...
        this._text_6 = this.renderer.createText(null, 'Company (Purchase)', null);
        ...
        this._TemplateRef_12_5 = new import29.TemplateRef_(this._appEl_12, viewFactory_PurchasePage1);
    ...
    _View_PurchasePage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_PurchasePage0.prototype.detectChangesInternal = function (throwOnChange) {
        var changes = null;
    ...
    _View_PurchasePage0.prototype.destroyInternal = function () {
        this._Content_10_4.ngOnDestroy();
    };
    return _View_PurchasePage0;
}(import1.AppView));
export function viewFactory_PurchasePage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_PurchasePage === null)) {
        (renderType_PurchasePage = viewUtils.createRenderComponentType('', 0, import12.ViewEncapsulation.None, styles_PurchasePage, {}));
    }
    return new _View_PurchasePage0(viewUtils, parentInjector, declarationEl);
}
var _View_PurchasePage1 = (function (_super) {
    __extends(_View_PurchasePage1, _super);
    function _View_PurchasePage1(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_PurchasePage1, renderType_PurchasePage, import7.ViewType.EMBEDDED, viewUtils, parentInjector, declarationEl, import8.ChangeDetectorStatus.CheckAlways);
    }
    _View_PurchasePage1.prototype.createInternal = function (rootSelector) {
        ...
        this._text_17 = this.renderer.createText(this._el_16, 'Quantity', null);
    ...
    _View_PurchasePage1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_PurchasePage1.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_3 = 'pie';
        if (import5.checkBinding(throwOnChange, this._expr_3, currVal_3)) {
        ...
        this.detectContentChildrenChanges(throwOnChange);
        var currVal_1 = import5.interpolate(1, 'card-tab-bg-', this.context.$implicit.color, ' font-bold');
        if (import5.checkBinding(throwOnChange, this._expr_1, currVal_1)) {
        ...
        var currVal_5 = import5.interpolate(1, ' ', this.context.$implicit.qty, '');
        ...
        var currVal_8 = import5.interpolate(1, ' ', this.context.$implicit.amount, '');
        ...
        var currVal_11 = import5.interpolate(1, ' ', this.context.$implicit.taxamount, '');
        ...
        var currVal_14 = import5.interpolate(1, ' ', this.context.$implicit.profit, '%');
    ...
    _View_PurchasePage1.prototype.destroyInternal = function () {
        this._Icon_20_3.ngOnDestroy();
        this._Icon_30_3.ngOnDestroy();
        this._Icon_43_3.ngOnDestroy();
        this._Icon_53_3.ngOnDestroy();
    };
    _View_PurchasePage1.prototype._handle_click_0_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this.parent.context.companyClicked($event, this.context.$implicit) !== false);
        return (true && pd_0);
    };
    return _View_PurchasePage1;
}(import1.AppView));
function viewFactory_PurchasePage1(viewUtils, parentInjector, declarationEl) {
    return new _View_PurchasePage1(viewUtils, parentInjector, declarationEl);
}
