...
import * as import3 from '../../providers/staff-service';
...
var renderType_StaffPage_Host = null;
var _View_StaffPage_Host0 = (function (_super) {
    __extends(_View_StaffPage_Host0, _super);
    function _View_StaffPage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_StaffPage_Host0, renderType_StaffPage_Host, import7.ViewType.HOST, viewUtils, parentInjector, declarationEl, import8.ChangeDetectorStatus.CheckAlways);
    }
    _View_StaffPage_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('page-staff', rootSelector, null);
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_StaffPage0(this.viewUtils, this.injector(0), this._appEl_0);
        this._StaffService_0_4 = new import3.StaffService(this.parentInjector.get(import9.Http));
        this._StaffPage_0_5 = new import4.StaffPage(this.parentInjector.get(import10.NavController), this._StaffService_0_4, this.parentInjector.get(import11.LoadingController));
        this._appEl_0.initComponent(this._StaffPage_0_5, [], compView_0);
        compView_0.create(this._StaffPage_0_5, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_StaffPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.StaffService) && (0 === requestNodeIndex))) {
            return this._StaffService_0_4;
        }
        if (((token === import4.StaffPage) && (0 === requestNodeIndex))) {
            return this._StaffPage_0_5;
        }
        return notFoundResult;
    };
    return _View_StaffPage_Host0;
}(import1.AppView));
function viewFactory_StaffPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_StaffPage_Host === null)) {
        (renderType_StaffPage_Host = viewUtils.createRenderComponentType('', 0, import12.ViewEncapsulation.None, [], {}));
    }
    return new _View_StaffPage_Host0(viewUtils, parentInjector, declarationEl);
}
export var StaffPageNgFactory = new import13.ComponentFactory('page-staff', viewFactory_StaffPage_Host0, import4.StaffPage);
var styles_StaffPage = [];
var renderType_StaffPage = null;
var _View_StaffPage0 = (function (_super) {
    __extends(_View_StaffPage0, _super);
    function _View_StaffPage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_StaffPage0, renderType_StaffPage, import7.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import8.ChangeDetectorStatus.CheckAlways);
    }
    _View_StaffPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_6 = this.renderer.createText(null, 'Company (Staff)', null);
        ...
        this._TemplateRef_12_5 = new import29.TemplateRef_(this._appEl_12, viewFactory_StaffPage1);
    ...
    _View_StaffPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_StaffPage0.prototype.detectChangesInternal = function (throwOnChange) {
        var changes = null;
        ...
        changes = null;
        var currVal_4 = this.context.staffData;
    ...
    _View_StaffPage0.prototype.destroyInternal = function () {
        this._Content_10_4.ngOnDestroy();
    };
    return _View_StaffPage0;
}(import1.AppView));
export function viewFactory_StaffPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_StaffPage === null)) {
        (renderType_StaffPage = viewUtils.createRenderComponentType('', 0, import12.ViewEncapsulation.None, styles_StaffPage, {}));
    }
    return new _View_StaffPage0(viewUtils, parentInjector, declarationEl);
}
var _View_StaffPage1 = (function (_super) {
    __extends(_View_StaffPage1, _super);
    function _View_StaffPage1(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_StaffPage1, renderType_StaffPage, import7.ViewType.EMBEDDED, viewUtils, parentInjector, declarationEl, import8.ChangeDetectorStatus.CheckAlways);
    }
    _View_StaffPage1.prototype.createInternal = function (rootSelector) {
    ...
    _View_StaffPage1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_StaffPage1.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_2 = 'pie';
        if (import5.checkBinding(throwOnChange, this._expr_2, currVal_2)) {
        ...
        var currVal_1 = import5.interpolate(1, '', this.context.$implicit.name, '');
        if (import5.checkBinding(throwOnChange, this._expr_1, currVal_1)) {
    ...
    _View_StaffPage1.prototype.destroyInternal = function () {
        this._Icon_20_3.ngOnDestroy();
        this._Icon_30_3.ngOnDestroy();
        this._Icon_43_3.ngOnDestroy();
        this._Icon_53_3.ngOnDestroy();
    };
    return _View_StaffPage1;
}(import1.AppView));
function viewFactory_StaffPage1(viewUtils, parentInjector, declarationEl) {
