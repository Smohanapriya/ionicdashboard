...
import * as import3 from '../../providers/stocks-service';
...
class _View_StockPage_Host0 extends import1.AppView<any> {
  ...
  _StocksService_0_4:import3.StocksService;
  _StockPage_0_5:import4.StockPage;
  constructor(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement) {
    super(_View_StockPage_Host0,renderType_StockPage_Host,import7.ViewType.HOST,viewUtils,parentInjector,declarationEl,import8.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._StocksService_0_4 = new import3.StocksService(this.parentInjector.get(import9.Http));
    this._StockPage_0_5 = new import4.StockPage(this._StocksService_0_4,this.parentInjector.get(import10.LoadingController),this.parentInjector.get(import11.NavController));
    this._appEl_0.initComponent(this._StockPage_0_5,([] as any[]),compView_0);
    compView_0.create(this._StockPage_0_5,this.projectableNodes,(null as any));
    this.init(([] as any[]).concat([this._el_0]),[this._el_0],([] as any[]),([] as any[]));
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.StocksService) && (0 === requestNodeIndex))) { return this._StocksService_0_4; }
    if (((token === import4.StockPage) && (0 === requestNodeIndex))) { return this._StockPage_0_5; }
    return notFoundResult;
  }
}
function viewFactory_StockPage_Host0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_StockPage_Host === (null as any))) { (renderType_StockPage_Host = viewUtils.createRenderComponentType('',0,import12.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_StockPage_Host0(viewUtils,parentInjector,declarationEl);
}
export const StockPageNgFactory:import13.ComponentFactory<import4.StockPage> = new import13.ComponentFactory<import4.StockPage>('page-stock',viewFactory_StockPage_Host0,import4.StockPage);
const styles_StockPage:any[] = ([] as any[]);
var renderType_StockPage:import0.RenderComponentType = (null as any);
class _View_StockPage0 extends import1.AppView<import4.StockPage> {
  _text_0:any;
  _el_1:any;
  ...
  /*private*/ _expr_4:any;
  constructor(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement) {
    super(_View_StockPage0,renderType_StockPage,import7.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import8.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._TemplateRef_12_5 = new import29.TemplateRef_(this._appEl_12,viewFactory_StockPage1);
...
export function viewFactory_StockPage0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<import4.StockPage> {
  if ((renderType_StockPage === (null as any))) { (renderType_StockPage = viewUtils.createRenderComponentType('',0,import12.ViewEncapsulation.None,styles_StockPage,{})); }
...
class _View_StockPage1 extends import1.AppView<any> {
  ...
  constructor(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement) {
    super(_View_StockPage1,renderType_StockPage,import7.ViewType.EMBEDDED,viewUtils,parentInjector,declarationEl,import8.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import32.Row) && ((58 <= requestNodeIndex) && (requestNodeIndex <= 69)))) { return this._Row_58_3; }
    if (((token === import32.Grid) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 70)))) { return this._Grid_10_3; }
    if (((token === import31.CardContent) && ((8 <= requestNodeIndex) && (requestNodeIndex <= 71)))) { return this._CardContent_8_3; }
    if (((token === import31.Card) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 72)))) { return this._Card_0_3; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_5:any = import5.interpolate(1,' ',this.context.$implicit.inwqty,'');
    ...
    const currVal_8:any = import5.interpolate(1,' ',this.context.$implicit.ouwqty,'');
    ...
    const currVal_11:any = import5.interpolate(1,' ',this.context.$implicit.clqty,'');
    ...
    const currVal_17:any = import5.interpolate(1,' ',this.context.$implicit.clqvalue,'');
...
function viewFactory_StockPage1(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
