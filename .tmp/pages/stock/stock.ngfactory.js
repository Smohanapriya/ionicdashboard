...
var _View_StockPage_Host0 = (function (_super) {
    ...
    function _View_StockPage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_StockPage_Host0, renderType_StockPage_Host, import7.ViewType.HOST, viewUtils, parentInjector, declarationEl, import8.ChangeDetectorStatus.CheckAlways);
    }
    _View_StockPage_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._appEl_0.initComponent(this._StockPage_0_5, [], compView_0);
        compView_0.create(this._StockPage_0_5, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_StockPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.StocksService) && (0 === requestNodeIndex))) {
            return this._StocksService_0_4;
        }
        if (((token === import4.StockPage) && (0 === requestNodeIndex))) {
            return this._StockPage_0_5;
        }
...
function viewFactory_StockPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_StockPage_Host === null)) {
        (renderType_StockPage_Host = viewUtils.createRenderComponentType('', 0, import12.ViewEncapsulation.None, [], {}));
    }
    return new _View_StockPage_Host0(viewUtils, parentInjector, declarationEl);
}
export var StockPageNgFactory = new import13.ComponentFactory('page-stock', viewFactory_StockPage_Host0, import4.StockPage);
...
var _View_StockPage0 = (function (_super) {
    ...
    function _View_StockPage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_StockPage0, renderType_StockPage, import7.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import8.ChangeDetectorStatus.CheckAlways);
    }
...
export function viewFactory_StockPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_StockPage === null)) {
        (renderType_StockPage = viewUtils.createRenderComponentType('', 0, import12.ViewEncapsulation.None, styles_StockPage, {}));
    }
...
var _View_StockPage1 = (function (_super) {
    ...
    function _View_StockPage1(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_StockPage1, renderType_StockPage, import7.ViewType.EMBEDDED, viewUtils, parentInjector, declarationEl, import8.ChangeDetectorStatus.CheckAlways);
    }
    ...
    _View_StockPage1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import32.Row) && ((58 <= requestNodeIndex) && (requestNodeIndex <= 69)))) {
            return this._Row_58_3;
        }
        if (((token === import32.Grid) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 70)))) {
            return this._Grid_10_3;
        }
        if (((token === import31.CardContent) && ((8 <= requestNodeIndex) && (requestNodeIndex <= 71)))) {
            return this._CardContent_8_3;
        }
        if (((token === import31.Card) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 72)))) {
    ...
    _View_StockPage1.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_5 = import5.interpolate(1, ' ', this.context.$implicit.inwqty, '');
        ...
        var currVal_8 = import5.interpolate(1, ' ', this.context.$implicit.ouwqty, '');
        ...
        var currVal_11 = import5.interpolate(1, ' ', this.context.$implicit.clqty, '');
        ...
        var currVal_17 = import5.interpolate(1, ' ', this.context.$implicit.clqvalue, '');
