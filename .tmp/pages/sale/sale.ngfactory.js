...
import * as import8 from '../../providers/sales-service';
...
var renderType_SalePage_Host = null;
var _View_SalePage_Host0 = (function (_super) {
    __extends(_View_SalePage_Host0, _super);
    function _View_SalePage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_SalePage_Host0, renderType_SalePage_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_SalePage_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('page-sale', rootSelector, null);
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_SalePage0(this.viewUtils, this.injector(0), this._appEl_0);
        ...
        compView_0.create(this._SalePage_0_4, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_SalePage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.SalePage) && (0 === requestNodeIndex))) {
            return this._SalePage_0_4;
        }
        return notFoundResult;
    };
    return _View_SalePage_Host0;
}(import1.AppView));
function viewFactory_SalePage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SalePage_Host === null)) {
        (renderType_SalePage_Host = viewUtils.createRenderComponentType('', 0, import11.ViewEncapsulation.None, [], {}));
    }
    return new _View_SalePage_Host0(viewUtils, parentInjector, declarationEl);
}
export var SalePageNgFactory = new import12.ComponentFactory('page-sale', viewFactory_SalePage_Host0, import3.SalePage);
var styles_SalePage = [];
var renderType_SalePage = null;
var _View_SalePage0 = (function (_super) {
    __extends(_View_SalePage0, _super);
    function _View_SalePage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_SalePage0, renderType_SalePage, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_SalePage0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_6 = this.renderer.createText(null, 'Company (Sale)', null);
        ...
        this._TemplateRef_12_5 = new import28.TemplateRef_(this._appEl_12, viewFactory_SalePage1);
    ...
    _View_SalePage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_SalePage0.prototype.detectChangesInternal = function (throwOnChange) {
        var changes = null;
    ...
    _View_SalePage0.prototype.destroyInternal = function () {
        this._Content_10_4.ngOnDestroy();
    };
    return _View_SalePage0;
}(import1.AppView));
...
var _View_SalePage1 = (function (_super) {
    __extends(_View_SalePage1, _super);
    function _View_SalePage1(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_SalePage1, renderType_SalePage, import6.ViewType.EMBEDDED, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_SalePage1.prototype.createInternal = function (rootSelector) {
    ...
    _View_SalePage1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_SalePage1.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_3 = 'pie';
        if (import4.checkBinding(throwOnChange, this._expr_3, currVal_3)) {
        ...
        var currVal_5 = import4.interpolate(1, ' ', this.context.$implicit.actsales, '');
        ...
        var currVal_8 = import4.interpolate(1, ' ', this.context.$implicit.discamt, '');
        ...
        var currVal_11 = import4.interpolate(1, ' ', this.context.$implicit.salesamt, '');
    ...
    _View_SalePage1.prototype.destroyInternal = function () {
        this._Icon_20_3.ngOnDestroy();
        this._Icon_30_3.ngOnDestroy();
        this._Icon_43_3.ngOnDestroy();
        this._Icon_53_3.ngOnDestroy();
    };
    _View_SalePage1.prototype._handle_click_0_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this.parent.context.companyClicked($event, this.context.$implicit) !== false);
        return (true && pd_0);
    };
    return _View_SalePage1;
}(import1.AppView));
function viewFactory_SalePage1(viewUtils, parentInjector, declarationEl) {
    return new _View_SalePage1(viewUtils, parentInjector, declarationEl);
}
