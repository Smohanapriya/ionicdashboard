...
import * as import15 from 'ng2-chartjs2/components/chart';
...
import * as import26 from '../../node_modules/ng2-chartjs2/components/chart.ngfactory';
var renderType_SalesGraph_Host:import0.RenderComponentType = (null as any);
class _View_SalesGraph_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _SalesGraph_0_4:import3.SalesGraph;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_SalesGraph_Host0,renderType_SalesGraph_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.selectOrCreateHostElement('page-sales-graph',rootSelector,(null as any));
    this._appEl_0 = new import2.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_SalesGraph0(this.viewUtils,this.injector(0),this._appEl_0);
    this._SalesGraph_0_4 = new import3.SalesGraph(this.parentInjector.get(import8.NavController));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.SalesGraph) && (0 === requestNodeIndex))) { return this._SalesGraph_0_4; }
...
function viewFactory_SalesGraph_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_SalesGraph_Host === (null as any))) { (renderType_SalesGraph_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_SalesGraph_Host0(viewUtils,parentInjector,declarationEl);
}
export const SalesGraphNgFactory:import10.ComponentFactory<import3.SalesGraph> = new import10.ComponentFactory<import3.SalesGraph>('page-sales-graph',viewFactory_SalesGraph_Host0,import3.SalesGraph);
...
class _View_SalesGraph0 extends import1.AppView<import3.SalesGraph> {
  ...
  _ChartComponent_12_4:import15.ChartComponent;
  _text_13:any;
  _text_14:any;
  /*private*/ _expr_0:any;
  /*private*/ _expr_1:any;
  ...
  /*private*/ _expr_5:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_SalesGraph0,renderType_SalesGraph,import6.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    const parentRenderNode:any = this.renderer.createViewRoot(this.declarationAppElement.nativeElement);
    this._text_0 = this.renderer.createText(parentRenderNode,'\n',(null as any));
    this._el_1 = this.renderer.createElement(parentRenderNode,'ion-header',(null as any));
    this._Header_1_3 = new import11.Header(this.parentInjector.get(import16.Config),new import17.ElementRef(this._el_1),this.renderer,this.parentInjector.get(import18.ViewController,(null as any)));
    ...
    this._Navbar_3_4 = new import12.Navbar(this.parentInjector.get(import20.App),this.parentInjector.get(import18.ViewController,(null as any)),this.parentInjector.get(import8.NavController,(null as any)),this.parentInjector.get(import16.Config),new import17.ElementRef(this._el_3),this.renderer);
    ...
    this._ToolbarTitle_5_4 = new import13.ToolbarTitle(this.parentInjector.get(import16.Config),new import17.ElementRef(this._el_5),this.renderer,this.parentInjector.get(import11.Toolbar,(null as any)),this._Navbar_3_4);
    ...
    var compView_12:any = import26.viewFactory_ChartComponent0(this.viewUtils,this.injector(12),this._appEl_12);
    this._ChartComponent_12_4 = new import15.ChartComponent(new import17.ElementRef(this._el_12));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import15.ChartComponent) && (12 === requestNodeIndex))) { return this._ChartComponent_12_4; }
    if (((token === import14.Content) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 13)))) { return this._Content_10_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (((this.numberOfChecks === 0) && !throwOnChange)) { this._Content_10_4.ngOnInit(); }
    const currVal_3:any = this.context.labels;
    if (import4.checkBinding(throwOnChange,this._expr_3,currVal_3)) {
      this._ChartComponent_12_4.labels = currVal_3;
      this._expr_3 = currVal_3;
    }
    const currVal_4:any = this.context.data;
    if (import4.checkBinding(throwOnChange,this._expr_4,currVal_4)) {
      this._ChartComponent_12_4.data = currVal_4;
      this._expr_4 = currVal_4;
    }
    const currVal_5:any = 'line';
    if (import4.checkBinding(throwOnChange,this._expr_5,currVal_5)) {
      this._ChartComponent_12_4.type = currVal_5;
      this._expr_5 = currVal_5;
    }
    if (((this.numberOfChecks === 0) && !throwOnChange)) { this._ChartComponent_12_4.ngOnInit(); }
    if (!throwOnChange) { this._ChartComponent_12_4.ngDoCheck(); }
...
export function viewFactory_SalesGraph0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.SalesGraph> {
  if ((renderType_SalesGraph === (null as any))) { (renderType_SalesGraph = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,styles_SalesGraph,{})); }
