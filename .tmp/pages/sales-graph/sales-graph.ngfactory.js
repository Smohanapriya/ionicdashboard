...
function viewFactory_SalesGraph_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SalesGraph_Host === null)) {
        (renderType_SalesGraph_Host = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, [], {}));
    }
    return new _View_SalesGraph_Host0(viewUtils, parentInjector, declarationEl);
}
export var SalesGraphNgFactory = new import10.ComponentFactory('page-sales-graph', viewFactory_SalesGraph_Host0, import3.SalesGraph);
...
var _View_SalesGraph0 = (function (_super) {
    ...
    _View_SalesGraph0.prototype.createInternal = function (rootSelector) {
        ...
        this._Header_1_3 = new import11.Header(this.parentInjector.get(import16.Config), new import17.ElementRef(this._el_1), this.renderer, this.parentInjector.get(import18.ViewController, null));
        ...
        this._Navbar_3_4 = new import12.Navbar(this.parentInjector.get(import20.App), this.parentInjector.get(import18.ViewController, null), this.parentInjector.get(import8.NavController, null), this.parentInjector.get(import16.Config), new import17.ElementRef(this._el_3), this.renderer);
        ...
        this._ToolbarTitle_5_4 = new import13.ToolbarTitle(this.parentInjector.get(import16.Config), new import17.ElementRef(this._el_5), this.renderer, this.parentInjector.get(import11.Toolbar, null), this._Navbar_3_4);
        ...
        var compView_12 = import26.viewFactory_ChartComponent0(this.viewUtils, this.injector(12), this._appEl_12);
    ...
    _View_SalesGraph0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import15.ChartComponent) && (12 === requestNodeIndex))) {
            return this._ChartComponent_12_4;
        }
        if (((token === import14.Content) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 13)))) {
    ...
    _View_SalesGraph0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_3 = this.context.labels;
...
export function viewFactory_SalesGraph0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SalesGraph === null)) {
        (renderType_SalesGraph = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, styles_SalesGraph, {}));
    }
