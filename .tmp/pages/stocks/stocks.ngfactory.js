...
var _View_StocksPage_Host0 = (function (_super) {
    ...
    function _View_StocksPage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_StocksPage_Host0, renderType_StocksPage_Host, import7.ViewType.HOST, viewUtils, parentInjector, declarationEl, import8.ChangeDetectorStatus.CheckAlways);
    }
    _View_StocksPage_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._appEl_0.initComponent(this._StocksPage_0_5, [], compView_0);
        compView_0.create(this._StocksPage_0_5, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_StocksPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.AllStocksService) && (0 === requestNodeIndex))) {
            return this._AllStocksService_0_4;
        }
        if (((token === import4.StocksPage) && (0 === requestNodeIndex))) {
            return this._StocksPage_0_5;
        }
...
function viewFactory_StocksPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_StocksPage_Host === null)) {
        (renderType_StocksPage_Host = viewUtils.createRenderComponentType('', 0, import13.ViewEncapsulation.None, [], {}));
    }
    return new _View_StocksPage_Host0(viewUtils, parentInjector, declarationEl);
}
export var StocksPageNgFactory = new import14.ComponentFactory('page-stocks', viewFactory_StocksPage_Host0, import4.StocksPage);
...
var _View_StocksPage0 = (function (_super) {
    ...
    function _View_StocksPage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_StocksPage0, renderType_StocksPage, import7.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import8.ChangeDetectorStatus.CheckAlways);
    }
...
export function viewFactory_StocksPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_StocksPage === null)) {
        (renderType_StocksPage = viewUtils.createRenderComponentType('', 0, import13.ViewEncapsulation.None, styles_StocksPage, {}));
    }
...
var _View_StocksPage1 = (function (_super) {
    ...
    function _View_StocksPage1(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_StocksPage1, renderType_StocksPage, import7.ViewType.EMBEDDED, viewUtils, parentInjector, declarationEl, import8.ChangeDetectorStatus.CheckAlways);
    }
    ...
    _View_StocksPage1.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_1 = import5.interpolate(1, '', this.context.$implicit.daterange, '');
        if (import5.checkBinding(throwOnChange, this._expr_1, currVal_1)) {
        ...
        var currVal_4 = import5.interpolate(1, ' ', this.context.$implicit.clqty, '');
        if (import5.checkBinding(throwOnChange, this._expr_4, currVal_4)) {
        ...
        var currVal_7 = import5.interpolate(1, ' ', this.context.$implicit.clqvalue, '');
        ...
        var currVal_10 = import5.interpolate(1, ' ', this.context.$implicit.salvalue, '');
